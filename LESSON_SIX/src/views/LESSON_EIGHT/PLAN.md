...
Use the Vite with TypeScript and Vue Router. Then add Vuetify 3 with 
Material Design Icons, and also install chart.js and vue-chartjs
for data visualizations. Set everything up and open the project.
...
## Interactions
- Month picker in the app bar filter EVERYTHING - summary cards show that month's numbers, charts highlight or filter to that month 
...
- Charts should use a cohensive color palette - not a rainbow
- Mobile reposive - cards stack on small screens
